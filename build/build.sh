...
if [ -z "${_IMAGES}" ]
then
    _IMAGES="swarm proxy certbot datashare_console datastore datastore_console database database_console core console public s3 worker_console pms-apt pms-yum pms-pacman pms-winget pms-wpt nfs-server"
fi
