...
DEFAULT_IMAGES="swarm manager proxy certbot datashare_console datastore datastore_console database database_console assistant mcp-server core console public worker_console tunnel pms-apt pms-yum pms-pacman pms-wpt pms-apk"
