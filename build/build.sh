...
if [ -z "${_IMAGES}" ]
then
    _IMAGES="swarm ca proxy certbot datashare_console datastore datastore_console database database_console assistant mcp-server core console public worker_console pms-apt pms-yum pms-pacman pms-wpt"
fi
